...
class Squad:
    def __init__(self, name, numberOfPlayer, age):
        self.players=[]
        self.name = name
...
class Tranfer:
    ...
    def setAttr(self,skill,pot,averageETV,matches,minutes_play,goals,assists,yellow_cards,yellow_red_cards,red_cards,lastTranfer):
        self.skill=skill
        self.pot=pot
